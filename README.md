...
| ---------------------------------------------- | ------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`lint.yml`](.github/workflows/lint.yml)       | push, PR            | pre-commit, tofu/terraform fmt, actionlint, yamllint, shellcheck, hadolint, ruff, mypy, clippy, cargo-deny, govulncheck                                                                                        |
| [`test.yml`](.github/workflows/test.yml)       | push, PR            | Matrix on opentofu 1.12 and terraform 1.5.7: validate + tflint + trivy config + checkov. e2e job brings up the infra tier and confirms LocalStack health. Python and Rust test jobs gated on manifest presence |
